...
topDarkBluePartForBoarding({BuildContext context}){
  return Column(
    children: [
      ...
      Stack(children: [
        ...
        Container(alignment: Alignment.center,
            child:Text("Boarding pass " , style: TextStyles.descriptionTextStyle.copyWith(color: whiteColor ,fontWeight: FontWeight.normal),),
            height: height(context)*.25,width: width(context),decoration: BoxDecoration(
